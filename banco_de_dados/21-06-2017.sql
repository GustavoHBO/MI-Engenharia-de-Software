...
CREATE TABLE `aquisicao_item` (
  `id_aquisicao_item` int(11) NOT NULL,
  ...
  CONSTRAINT `fk_Aquisicao_Item1` FOREIGN KEY (`Item_id_item`) REFERENCES `item` (`id_item`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `caracteristicas_estilisticas_item` (
  `id_caracteristicas_estilisticas_item` int(11) NOT NULL,
  ...
  CONSTRAINT `fk_Caracteristicas_estilisticas_item_Item1` FOREIGN KEY (`Item_id_item`) REFERENCES `item` (`id_item`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cria_evento` (
  ...
  CONSTRAINT `fk_Cria_evento_Evento1` FOREIGN KEY (`Evento_id_evento`) REFERENCES `evento` (`id_evento`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cria_evento_Usuario1` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cria_exposicao` (
  ...
  CONSTRAINT `fk_Logs_1_Exposicao1` FOREIGN KEY (`Exposicao_id_exposicao`) REFERENCES `exposicao` (`id_exposicao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Logs_1_Usuario3` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cria_item` (
  ...
  CONSTRAINT `fk_Logs_Item1` FOREIGN KEY (`Item_id_item`) REFERENCES `item` (`id_item`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Logs_Usuario1` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `desabilita_pesquisa` (
  ...
  CONSTRAINT `fk_Logs_Pesquisa1` FOREIGN KEY (`Pesquisa_id_pesquisa`) REFERENCES `pesquisa` (`id_pesquisa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Logs_Usuario3` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dimensao_item` (
  `id_dimensao_item` int(11) NOT NULL,
  ...
  CONSTRAINT `fk_Dimensao_item_Item1` FOREIGN KEY (`Item_id_item`) REFERENCES `item` (`id_item`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `documentacao_fotografica_item` (
  `id_documentacao_fotografica_item` int(11) NOT NULL,
  ...
  CONSTRAINT `fk_Documentacao_fotografica_item_Item1` FOREIGN KEY (`Item_id_item`) REFERENCES `item` (`id_item`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `edita_evento` (
  ...
  CONSTRAINT `fk_Edita_evento_Evento1` FOREIGN KEY (`Evento_id_evento`) REFERENCES `evento` (`id_evento`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Edita_evento_Usuario1` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `edita_exposicao` (
  ...
  CONSTRAINT `fk_Logs_Exposicao1` FOREIGN KEY (`Exposicao_id_exposicao`) REFERENCES `exposicao` (`id_exposicao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Logs_Usuario2` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `edita_item` (
  ...
  CONSTRAINT `fk_Logs_1_Item1` FOREIGN KEY (`Item_id_item`) REFERENCES `item` (`id_item`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Logs_1_Usuario1` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `editar_noticia` (
  ...
  CONSTRAINT `fk_Editar_noticia_Noticia1` FOREIGN KEY (`Noticia_id_noticia`) REFERENCES `noticia` (`id_noticia`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Editar_noticia_Usuario1` FOREIGN KEY (`Usuario_id_user`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `favorita_evento` (
  ...
  CONSTRAINT `fk_Favorita_evento_Evento1` FOREIGN KEY (`Evento_id_evento`) REFERENCES `evento` (`id_evento`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Favorita_evento_Usuario1` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `favorita_item` (
  ...
  CONSTRAINT `fk_Logs_1_Item2` FOREIGN KEY (`Item_id_item`) REFERENCES `item` (`id_item`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Logs_1_Usuario2` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_exposicao` (
  ...
  CONSTRAINT `fk_Item_exposicao_Exposicao1` FOREIGN KEY (`Exposicao_id_exposicao`) REFERENCES `exposicao` (`id_exposicao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Item_exposicao_Item1` FOREIGN KEY (`Item_id_item`) REFERENCES `item` (`id_item`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_imagem` (
  `id_item_imagem` int(11) NOT NULL,
  `foto_url` longtext NOT NULL,
  `Item_id_item` int(11) NOT NULL,
  PRIMARY KEY (`id_item_imagem`,`Item_id_item`),
  KEY `fk_Item_imagem_Item1_idx` (`Item_id_item`),
  CONSTRAINT `fk_Item_imagem_Item1` FOREIGN KEY (`Item_id_item`) REFERENCES `item` (`id_item`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `noticia` (
  ...
  CONSTRAINT `fk_Noticia_Usuario` FOREIGN KEY (`Usuario_id_user`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `noticia_imagem` (
  `id_noticia_imagem` int(11) NOT NULL,
  `foto_url` longtext NOT NULL,
  `Noticia_id_noticia` int(11) NOT NULL,
  PRIMARY KEY (`id_noticia_imagem`,`Noticia_id_noticia`),
  KEY `fk_template 4_Noticia1_idx` (`Noticia_id_noticia`),
  CONSTRAINT `fk_template 4_Noticia1` FOREIGN KEY (`Noticia_id_noticia`) REFERENCES `noticia` (`id_noticia`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `permissao` (
  ...
  CONSTRAINT `fk_Permissao_Usuario1` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pesquisa` (
  ...
  CONSTRAINT `fk_Pesquisa_Usuario1` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `remove_evento` (
  ...
  CONSTRAINT `fk_Exclui_evento_Evento1` FOREIGN KEY (`Evento_id_evento`) REFERENCES `evento` (`id_evento`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Exclui_evento_Usuario1` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `remove_exposicao` (
  ...
  CONSTRAINT `fk_Logs_2_Exposicao1` FOREIGN KEY (`Exposicao_id_exposicao`) REFERENCES `exposicao` (`id_exposicao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Logs_2_Usuario1` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `remove_item` (
  ...
  CONSTRAINT `fk_Remove_item_Item1` FOREIGN KEY (`Item_id_item`) REFERENCES `item` (`id_item`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Remove_item_Usuario1` FOREIGN KEY (`Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `remove_noticia` (
  ...
  CONSTRAINT `fk_Remove_noticia_Noticia1` FOREIGN KEY (`Noticia_id_noticia`) REFERENCES `noticia` (`id_noticia`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Remove_noticia_Usuario1` FOREIGN KEY (`Usuario_id_user`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-06-21 19:51:06
